...
<?php
	...
	//Checking is user existing in the database or not
        $query = "SELECT * FROM `h_users` WHERE h_user_name='$username' and h_password='".md5($password)."'";
...
<br/>
<center><button align="center" onclick="window.location.href='/YC_FEED'" class="w3-button w3-blue w3-large" style="width:auto;"> GO TO HOME</button></center>
...
<form class="w3-container" method="POST">
    <div class="w3-container">
      <label for="uname"><b>SELECT BRANCH [User Name]</b></label>
