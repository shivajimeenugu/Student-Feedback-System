...
require('db.php');
include("letc_auth.php"); //include auth.php file on all secure pages ?>
...
<br/>
  ...
  <button class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'London')">LOG OPTIONS</button>
...
<br/>
  <center> <button class="w3-btn w3-yellow w3-border" onclick="window.location.href='add_log.php'">ADD LOG</button></center><br/>
  <center> <button class="w3-btn w3-yellow w3-border" onclick="window.location.href='show.php'">ALL REPORTS </button></center><br/>
    <center> <button class="w3-btn w3-yellow w3-border" onclick="window.location.href='sort_by_date.php'">REPORTS</button></center><br/>
<center> <button class="w3-btn w3-yellow w3-border" onclick="document.getElementById('id01').style.display='block'">SUBMIT REPORTS TO HOD</button></center><br/>
...
{color:#fff;background-color:#00477e}
  ...
  <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
	...
	<center><p class="w3-tag w3-highway-schoolbus w3-xlarge w3-card">SELECT SUBJECT</p></center><br/>
	<table  class="w3-container">
	<?php 
	$emp_id_ret=$_SESSION["letc_username"];
	$q_get_sub="SELECT sub_code,sub_name from sub_db where sub_allotted='$emp_id_ret'";
	...
	?>
	<tr>
	<td><button class="w3-tag w3-highway-schoolbus w3-xlarge w3-card" onclick="window.location.href ='letc_submit_panal.php?sub_code_geted=<?php echo $row_re_row["sub_code"]; ?>';"><?php echo $row_re_row["sub_name"].'['.$row_re_row["sub_code"].']'; ?>  </button></td>
	</tr>
	<?php }?>
